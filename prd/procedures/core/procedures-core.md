...
Core processes governing conversation flow, tool execution, and permission evaluation.

| Module | Procedure | Description |
|--------|-----------|-------------|
| [Conversation](conversation/procedure-conversation-flow.md) | Conversation Flow | End-to-end flow of a user-Claude conversation turn |
